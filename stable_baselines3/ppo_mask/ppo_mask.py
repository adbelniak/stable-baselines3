...
from stable_baselines3.common.maskable.buffers import MaskableDictRolloutBuffer, MaskableRolloutBuffer
...
class MaskablePPO(OnPolicyAlgorithm):
    ...
    def _init_callback(
        ...
        if eval_env is not None:
            ...
            from stable_baselines3.common.maskable.callbacks import MaskableEvalCallback
